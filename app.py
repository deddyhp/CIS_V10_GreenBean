...
st.markdown("""
<div class="hero">
    <div class="hero-badge">☕ NEW CIS V10.11 · Green Bean + Brew Things</div>
...
with s3: st.markdown('<div class="stat-box"><div class="num">1</div><div class="label">Roasting Utility</div></div>', unsafe_allow_html=True)
...
st.markdown('<h3 class="section-title">Roasting Utility</h3>', unsafe_allow_html=True)
st.markdown("""
<div class="info-card" style="min-height:auto;">
    <h3>🔥 Roasting Plan</h3>
    <p style="color:#a8c7b4;">Plan manual dan S³ Roasting Guide untuk dibuka di tablet saat Artisan berjalan di laptop.</p>
    <ul style="color:#a8c7b4;">
        <li>Manual Preheat, Drying, Maillard, First Crack, Development, dan Drop</li>
        <li>Guide Mode lengkap untuk pendamping roasting</li>
        <li>Rating, evaluation, usage count, search, dan recall</li>
        <li>Disimpan ke worksheet Google Sheets <code>roasting_plans</code></li>
    </ul>
</div>
""", unsafe_allow_html=True)
...
st.info("CIS tetap memiliki dua core pillar: Green Bean dan Brew Things. Roasting Plan hadir sebagai utility tablet; roast log dan analisis aktual tetap berada di RPA.")
