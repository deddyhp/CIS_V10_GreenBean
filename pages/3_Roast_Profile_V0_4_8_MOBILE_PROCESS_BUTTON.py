...
def render_ai_roast_analysis() -> None:
    ...
    if mode == "Analyze Single Roast":
        uploaded = st.file_uploader(
            "Upload one Artisan .alog / ZIP",
            type=None,
            key="ai_single",
            help="Bisa pilih .alog langsung atau ZIP berisi satu .alog."
        )
...
def app() -> None:
    ...
    st.caption("CIS Roast Log V0.4.8 — explicit mobile upload processing and AI Roast Analysis.")
    ...
    uploaded = st.file_uploader(
        "Upload Artisan .alog / ZIP / TXT",
        type=None,
        key="daily_roast_upload",
        help="Pilih file, lalu tekan Process Upload.",
    )
