...
for ver, status, note in [
    ("V10.18", "Chaty Library Save Variable Fix", "Memperbaiki error variabel existing saat menyimpan Chaty Import baru ke Plan Library. Source Chaty Import kini disimpan aman tanpa menganggap plan baru sebagai mode edit."),
    ("V10.17", "Large Roasting Guide Typography", "Memperbesar dan menebalkan seluruh token BT beserta angkanya dua tingkat, serta G/A beserta angkanya satu tingkat pada S³ Guide Mode agar lebih nyaman dibaca dari tablet saat roasting."),
...
for ver, status, note in [
    ("V1.7", "Chaty Library Save Variable Fix", "Memperbaiki alur penyimpanan plan baru agar variabel existing selalu terdefinisi dan source Chaty Import tersimpan aman ke library."),
    ("V1.6", "Senior-Friendly Guide Typography", "Guide Mode menonjolkan BT dan angkanya dengan ukuran dua tingkat lebih besar dan bold, sementara setting G dan A satu tingkat lebih besar dan bold untuk keterbacaan operasional dari jarak kerja."),
